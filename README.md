...
plugin {
    gollum {
        ...
        fit   = top  # when missing columns, center/fill/top (default center)
        dir   = r    # horizontal orientation, left/right (default: l)
        new   = top  # new window position, top/bottom/next/prev/smart (default: b)
        order = 1234 # repeating column pattern to follow instead of default master-ish logic (default: empty)
    }
}
